---
{"dg-publish":true,"permalink":"/notes/file-p10k-zsh/"}
---
...
# File .p10k.zsh
```bash
# Generated by Powerlevel10k configuration wizard on 2022-07-07 at 17:18 IDT.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=236 # Almog
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=243 # Almog
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=149 # ALMOG
  # Default current directory foreground color.
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=236 # Almog (was 254)
  ...
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=30
